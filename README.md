...
🚀 Project Overview
This project implements a basic SSH honeypot in Python, inspired by The Security Buddy’s video tutorial. It listens for incoming SSH connections, simulates a login prompt, and logs the attacker’s inputs—such as username, password, and source IP address.
...
✅ Logs attacker credentials (username, password)

✅ Captures IP addresses and timestamps

✅ Lightweight and easy to run on any Linux system

✅ Good for threat intel, training, or demo use
